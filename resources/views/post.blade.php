...
<div class="card my-3">
    ...
    <div class="card-body text-center">
      ...
      <p>
        <small>
          By <a href="/authors/{{ $posts[0]->user->username }}">{{ $posts[0]->user->name }}</a> in <a href="/categories/{{ $posts[0]->category->name }}">{{ $posts[0]->category->name }}</a>
  ...
  <div class="row mb-5">
    ...
    <div class="col-md-4">
      <div class="card mb-3">
        ...
        <div class="position-absolute px-3 py-2" style="background-color: rgba(0,0,0,0.6)"><a href="/categories/{{ $post->category->name }}" class="text-decoration-none text-white">{{ $post->category->name }}</a></div>
        <div class="card-body">
